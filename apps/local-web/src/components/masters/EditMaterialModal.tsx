  ...
  useEffect(() => {
    if (isOpen && material) {
      ...
      if (material.specifications) {
        try {
          specs = JSON.parse(material.specifications)
        } catch {
          specs = {}
        }
      }
      ...
      setFormData({
        ...
        industryCategory: material.industryCategory || '',
        division: material.division || 'common',
        unit: material.unit || '',
        hsnCode: material.hsnCode || '',
        technicalGrade: material.technicalGrade || '',
        complianceStandard: material.complianceStandard || '',
        specifications: material.specifications || '',
        criticalItem: material.criticalItem || false,
        shelfLife: material.shelfLife || 0,
        storageConditions: material.storageConditions || '',
        hazardCategory: material.hazardCategory || 'Non-Hazardous',
        reorderLevel: material.reorderLevel || 0,
        reorderQuantity: material.reorderQuantity || 0,
        minOrderQuantity: material.minOrderQuantity || 0,
        maxOrderQuantity: material.maxOrderQuantity || 0,
        leadTimeDays: material.leadTimeDays || 0,
        preferredVendors: material.preferredVendors || [],
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updateData = {
        ...
        technicalGrade: formData.technicalGrade,
        complianceStandard: formData.complianceStandard,
        specifications: formData.specifications,
        criticalItem: formData.criticalItem,
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/materials/${material.id}`, {
        method: 'PUT',
        headers: {
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-5xl w-full max-h-[90vh] overflow-hidden">
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Edit Material</h2>
                <p className="text-sm text-gray-600 dark:text-gray-400">Update material: {material.code}</p>
              </div>
            </div>
            <button
              onClick={onClose}
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-blue-900 dark:text-blue-100 mb-1">
                      Material Code Update
                    </h4>
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      The material code cannot be changed. If you need a different code, please create a new material.
                    </p>
                  </div>
                </div>
              </div>
