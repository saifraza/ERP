...
export default function EditVendorModal({ vendor, isOpen, onClose, onSuccess }: EditVendorModalProps) {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    setFormData(prev => ({
      ...
      [name]: type === 'checkbox' ? (e.target as HTMLInputElement).checked : 
              name === 'creditLimit' || name === 'creditDays' ? Number(value) : value
    }))
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Code: {vendor.code}</p>
              </div>
            </div>
            <button
              onClick={onClose}
